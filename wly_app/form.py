...
class BodyCheckForm(forms.Form):
    hight = forms.DecimalField(max_digits=4,required=True,error_messages={"required":"身高不能为空",'max_digits':"身高最多为3位数"})
    ...
    maxh = forms.DecimalField(max_digits=4,required=True, error_messages={'required': "最大心率不能为空",'max_digits':"最大心率最多为3位数"})
